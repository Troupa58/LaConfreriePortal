...
- phrase d'accueil aléatoire à chaque visite ;
- meilleure lisibilité générale ;
- séparation visuelle entre les chapitres ;
- carte de mission principale renforcée ;
- effets de survol discrets ;
- barre de navigation plus nette pendant le défilement ;
- détails visuels supplémentaires sans alourdir le chargement.
